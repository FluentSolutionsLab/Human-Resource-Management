...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRManagement.Modules.Personnel.Domain.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HRManagement.Modules.Personnel.Domain.Role", b =>
                {
                    b.Property<byte>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint")
            ...
            modelBuilder.Entity("HRManagement.Modules.Personnel.Domain.Employee", b =>
                {
                    b.HasOne("HRManagement.Modules.Personnel.Domain.Employee", "Manager")
                        .WithMany("ManagedEmployees")
                        .HasForeignKey("ManagerId");

                    b.HasOne("HRManagement.Modules.Personnel.Domain.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("HRManagement.Modules.Personnel.Domain.DateOfBirth", "DateOfBirth", b1 =>
                        {
            ...
            modelBuilder.Entity("HRManagement.Modules.Personnel.Domain.Role", b =>
                {
                    b.HasOne("HRManagement.Modules.Personnel.Domain.Role", "ReportsTo")
                        .WithMany()
